...
module.exports.bootstrap = async function() {
  ...
  await User.createEach([
    { emailAddress: 'admin@us.er', fullName: 'Ryan Dahl', isSuperAdmin: true, password: await sails.helpers.passwords.hashPassword('1') },
    { emailAddress: 'admin2@us.er', fullName: 'Ryan Dahl', isSuperAdmin: true, password: await sails.helpers.passwords.hashPassword('1') },
    { emailAddress: 'admin3@us.er', fullName: 'Ryan Dahl', isSuperAdmin: true, password: await sails.helpers.passwords.hashPassword('1') },
    { emailAddress: 'admin4@us.er', fullName: 'Ryan Dahl', isSuperAdmin: true, password: await sails.helpers.passwords.hashPassword('1') },
  ]);
